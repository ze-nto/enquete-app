...
describe('RemoteLoadSurveyList', () => {
  ...
  test('Should throw UnexpecteError if HttpGetClient returns 403', async () => {
  ...
  test('Should throw UnexpecteError if HttpGetClient returns 404', async () => {
    const { sut, httpGetClientSpy } = makeSut()
    httpGetClientSpy.response = {
  ...
  test('Should throw UnexpecteError if HttpGetClient returns 500', async () => {
    const { sut, httpGetClientSpy } = makeSut()
    httpGetClientSpy.response = {
  ...
  test('Should return an list of SurveyModel if HttpGetClient returns 200', async () => {
    const { sut, httpGetClientSpy } = makeSut()
